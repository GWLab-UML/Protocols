...
see below [to set up automatic backups to GitHub](https://github.com/GWLab-UML/Protocols/blob/main/Computational/macOS-Obsidian2GitHub.md#to-set-up-automatic-backups-to-github)
